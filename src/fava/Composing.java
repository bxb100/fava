...
public class Composing {
	 ...
	 * <p>_ :: (T -> U) -> (U -> R) -> T -> R
	 */
	public static <T, U, R> F1<T, R> _do(final IF1<T, U> f1, final IF1<U, R> f2) {
		return new F1<>() {
			@Override
	 ...
	 */
	public static <T, U1, U2, R> F1<T, R> _do(final IF1<T, U1> f1, final IF1<U1, U2> f2, final IF1<U2, R> f3) {
		return _do(_do(f1, f2), f3);
	}
	 ...
	 */
	public static <T, U1, U2, U3, R> F1<T, R> _do(
			final IF1<T, U1> f1,
			final IF1<U1, U2> f2,
			final IF1<U2, U3> f3,
			final IF1<U3, R> f4) {
		return _do(_do(f1, f2, f3), f4);
	}
	 ...
	 */
	public static <T, U1, U2, U3, U4, R> F1<T, R> _do(
			final IF1<T, U1> f1,
			final IF1<U1, U2> f2,
			final IF1<U2, U3> f3,
			final IF1<U3, U4> f4,
			final IF1<U4, R> f5) {
		return _do(_do(f1, f2, f3, f4), f5);
	}
	 ...
	 */
	public static <T, U1, U2, U3, U4, U5, R> F1<T, R> _do(
			final IF1<T, U1> f1,
			final IF1<U1, U2> f2,
			final IF1<U2, U3> f3,
			final IF1<U3, U4> f4,
			final IF1<U4, U5> f5,
			final IF1<U5, R> f6) {
		return _do(_do(f1, f2, f3, f4, f5), f6);
	}
}
